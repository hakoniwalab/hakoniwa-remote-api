...
namespace hakoniwa.pdu.msgs.hako_srv_msgs
{
    public class GetSimStateRequestPacket
    {
        ...
        public GetSimStateRequestPacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private GetSimStateRequest _body;
        public GetSimStateRequest body
        {
            get
            {
                if (_body == null)
                {
                    _body = new GetSimStateRequest(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
