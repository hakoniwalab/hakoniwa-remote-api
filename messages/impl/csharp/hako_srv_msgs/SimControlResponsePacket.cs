...
namespace hakoniwa.pdu.msgs.hako_srv_msgs
{
    public class SimControlResponsePacket
    {
        ...
        public SimControlResponsePacket(IPdu pdu)
        {
            _pdu = pdu;
        }
        ...
        private SimControlResponse _body;
        public SimControlResponse body
        {
            get
            {
                if (_body == null)
                {
                    _body = new SimControlResponse(_pdu.GetData<IPdu>("body"));
                }
                return _body;
            }
            set
