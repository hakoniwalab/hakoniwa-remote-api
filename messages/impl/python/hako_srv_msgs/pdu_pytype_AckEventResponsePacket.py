...
from ..hako_srv_msgs.pdu_pytype_AckEventResponse import AckEventResponse
...
class AckEventResponsePacket:
    ...
    body: AckEventResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = AckEventResponse()

    def __str__(self):
        return f"AckEventResponsePacket(" + ", ".join([
