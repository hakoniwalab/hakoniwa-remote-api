...
from ..hako_srv_msgs.pdu_pytype_GetSimStateRequest import GetSimStateRequest
...
class GetSimStateRequestPacket:
    ...
    body: GetSimStateRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = GetSimStateRequest()

    def __str__(self):
        return f"GetSimStateRequestPacket(" + ", ".join([
