...
from ..hako_srv_msgs.pdu_pytype_GetSimStateResponse import GetSimStateResponse
...
class GetSimStateResponsePacket:
    ...
    body: GetSimStateResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = GetSimStateResponse()

    def __str__(self):
        return f"GetSimStateResponsePacket(" + ", ".join([
