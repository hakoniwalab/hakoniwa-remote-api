...
from ..hako_srv_msgs.pdu_pytype_SimControlRequest import SimControlRequest
...
class SimControlRequestPacket:
    ...
    body: SimControlRequest

    def __init__(self):
        self.header = ServiceRequestHeader()
        self.body = SimControlRequest()

    def __str__(self):
        return f"SimControlRequestPacket(" + ", ".join([
