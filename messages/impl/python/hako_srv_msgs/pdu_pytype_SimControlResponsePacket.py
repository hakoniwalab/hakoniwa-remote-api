...
from ..hako_srv_msgs.pdu_pytype_SimControlResponse import SimControlResponse
...
class SimControlResponsePacket:
    ...
    body: SimControlResponse

    def __init__(self):
        self.header = ServiceResponseHeader()
        self.body = SimControlResponse()

    def __str__(self):
        return f"SimControlResponsePacket(" + ", ".join([
